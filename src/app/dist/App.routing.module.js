...
exports.routes = [
    ...
    { path: 'extrato', component: extrato_component_1.ExtratoComponent },
    { path: 'nova-transferencia', component: nova_Transferencia_component_1.NovaTransferenciaComponent }
];
